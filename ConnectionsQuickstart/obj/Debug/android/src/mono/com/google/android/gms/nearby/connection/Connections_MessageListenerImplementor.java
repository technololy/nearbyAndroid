...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Android.Gms.Nearby.Connection.IConnectionsMessageListenerImplementor, Xamarin.GooglePlayServices.Nearby", Connections_MessageListenerImplementor.class, __md_methods);
	}


	public Connections_MessageListenerImplementor ()
	{
		super ();
		if (getClass () == Connections_MessageListenerImplementor.class)
			mono.android.TypeManager.Activate ("Android.Gms.Nearby.Connection.IConnectionsMessageListenerImplementor, Xamarin.GooglePlayServices.Nearby", "", this, new java.lang.Object[] {  });
	}
